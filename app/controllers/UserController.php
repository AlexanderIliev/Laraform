...
class UserController extends BaseController
{
    ...
    public function postCreate()
    {
        ...
        if ($validate->fails())
        {
            return Redirect::route('getCreate')->withInput()->withErrors($validate);
        }
        else
        {
            ...
            {
                return Redirect::route('home')->with('fail', 'An error occured while creating a new user. Please try again.');
            }
        }
    }
    ...
    public function postLogin()
    {
        ...
        if($validator->fails())
        {
            return Redirect::route('getLogin')->withInput()->withErrors($validator);
        }
        else
        {
